...
import FoodingForm from "./fooding-form"

export default function FoodingHeader() {
  return (
      ...
      <CardContent className="flex items-start gap-4">
        ...
        <div className="space-y-1">
          ...
          <p className="max-w-xl text-sm text-muted-foreground">
            Create and manage fooding in this hostel. Control access to fooding,
            meals, students, billing, and more.
          </p>
        </div>
      </CardContent>
